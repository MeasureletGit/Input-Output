...
def set_container(type, weight, comment=''):
    ...
    button1.grid(row=0, column=0, padx=3, pady=125, sticky='NSEW')
    button1.config(font=('Helvetica', 23))
    # button1.pack()
    ...
    button2.grid(row=0, column=1, padx=3, pady=125, sticky='NSEW')
    button2.config(font=('Helvetica', 23))
    # button2.pack()

    button3 = tk.Button(master=backstaffpicker, text='Kande\n500 ml', command = lambda: approve(type, str(int(weight) - jug_weight), comment, "Kande 500ml"), bg = '#007f93', fg = 'white', height = 1, width = 1)
    button3.grid(row=0, column=2, padx=3, pady=125, sticky='NSEW')
    button3.config(font=('Helvetica', 23))
    # button3.pack()

    button4 = tk.Button(master=backstaffpicker, text=' Juice \n Mælk Lille\n Dåse \n Tudekop \n Kakao', command = lambda: approve(type, str(int(weight) - diverse_weight), comment, 'Diverse'), bg = '#007f93', fg = 'white', height = 1, width = 1)
    button4.grid(row=0, column=3, padx=3, pady=125, sticky='NSEW')
    button4.config(font=('Helvetica', 18))
    
    button5 = tk.Button(master=backstaffpicker, text='Proteindrik', command = lambda: approve(type, str(int(weight) - proteinDrink_weight), comment, 'Proteindrik'), bg = '#007f93', fg = 'white', height = 1, width = 1)
    button5.grid(row=0, column=4, padx=3, pady=125, sticky='NSEW')
    button5.config(font=('Helvetica', 18))

    button6 = tk.Button(master=backstaffpicker, text='Skål', command = lambda: approve(type, str(int(weight) - bowl_weight), comment, 'Skål'), bg = '#007f93', fg = 'white', height = 1, width = 1)
    button6.grid(row=0, column=5, padx=3, pady=125, sticky='NSEW')
    button6.config(font=('Helvetica', 23))

    backstaffpicker.rowconfigure(0, weight=1)
    backstaffpicker.grid_columnconfigure(0, weight=1)
    backstaffpicker.grid_columnconfigure(1, weight=1)
    backstaffpicker.grid_columnconfigure(2, weight=1)
    backstaffpicker.grid_columnconfigure(3, weight=1)
    backstaffpicker.grid_columnconfigure(4, weight=1)
    backstaffpicker.grid_columnconfigure(5, weight=1)    
...
def set_container_output(type, weight, comment=''):
    ...
    bigBedpan_weight = 411
    littleBedpan_weight = 337
    bigJug_weight = 181
    littleJug_weight = 61
    diaper_weight = 92
    ...
    button1 = tk.Button(master=backstaffpicker, text='Stort \nbækken \nuden låg',
        command=lambda: approve(type, str(int(weight) - bigBedpan_weight), comment, "Stort bækken"),
        bg='#007f93', fg='white', height=1, width=1)
    button1.grid(row=0, column=0, padx=3, pady=125, sticky='NSEW')
    button1.config(font=('Helvetica', 22))

    button2 = tk.Button(master=backstaffpicker, text='Lille \nbækken\nuden låg',
        command=lambda: approve(type, str(int(weight) - littleBedpan_weight), comment, "Lille bækken"),
        bg='#007f93', fg='white', height=1, width=1)
    button2.grid(row=0, column=1, padx=3, pady=125, sticky='NSEW')
    button2.config(font=('Helvetica', 22))

    button3 = tk.Button(master=backstaffpicker, text='Stor \nkande\n2000ml',
        command=lambda: approve(type, str(int(weight) - bigJug_weight), comment, "Stor kande"),
        bg='#007f93', fg='white', height=1, width=1)
    button3.grid(row=0, column=2, padx=3, pady=125, sticky='NSEW')
    button3.config(font=('Helvetica', 22))

    button4 = tk.Button(master=backstaffpicker, text='Lille \nkande\n500ml',
        command=lambda: approve(type, str(int(weight) - littleJug_weight), comment, "Lille kande"),
        bg='#007f93', fg='white', height=1, width=1)
    button4.grid(row=0, column=3, padx=3, pady=125, sticky='NSEW')
    button4.config(font=('Helvetica', 22))

    button5 = tk.Button(master=backstaffpicker, text='Ble',
        command=lambda: approve(type, str(int(weight) - diaper_weight), comment, "Ble"),
        bg='#007f93', fg='white', height=1, width=1)
    button5.grid(row=0, column=4, padx=3, pady=125, sticky='NSEW')
    button5.config(font=('Helvetica', 22))
...
def verify(type, mass, comment='', container_type=None):
    ...
    if container_type == 'Glas' and type =='K':
        ...
        typs = 'Kop'
    elif container_type == 'Kande 500ml' and type == 'K':
        typs = 'Kande 500ml '
    elif container_type == 'Kande 500ml' and type == 'I':
        typs = 'Kande 500ml'
    elif container_type == 'Diverse' and type == 'K':
        typs = 'Diverse '
    elif container_type == 'Diverse' and type == 'I':
        typs = 'Diverse'
    elif container_type == 'Proteindrik' and type == 'K':
        typs = 'Proteindrik '
    elif container_type == 'Proteindrik' and type == 'I':
        typs = 'Proteindrik'
    elif container_type == 'Skål' and type == 'K':
        typs = 'Skål '
    elif container_type == 'Skål' and type == 'I':
        typs = 'Skål'
    ...
    if container_type in ('Glas', 'Kop', 'Kande 500ml', 'Juice \n Mælk lille \n dåse \n Tudekop \n Kakao', 'Proteindrik', 'Skål'):
...
def welcome():
    ...
    '''afslut_bruger = tk.Button(
        master=back,
        text='AFSLUT BRUGER',
        bg='#525252',
        fg='white',
        command=lambda: end_user(),
        height=1,
        width=25
    )
    afslut_bruger.grid(row=2, column=1, sticky='NSEW', padx=10, pady=10)
    afslut_bruger.configure(font=('Helvetica', '22'))'''
...
def end_user():
    ...
    backswitch_label1 = tk.Label(master=backstaffpicker, text='Bruger afsluttet \n\n\n Skan armbånd for at oprette ny bruger', bg='#fafafa')
    ...
    backstaffpicker.rowconfigure(3, weight=1)
    backstaffpicker.rowconfigure(4, weight=1)
    backstaffpicker.rowconfigure(5, weight=1)
        ...
        for key, value in test_dict.items():
            for vals in value:
                if key in total_dict:
                    if vals[1] in ['Glas ', 'Kop ', 'Kande 500ml ', 'Diverse ', 'Proteindrik ', 'Skål ']:
