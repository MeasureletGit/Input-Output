...
def set_container(type, weight, comment=''):
    ...
    plasticGlass_weight = 3
    cardboardCup_weight = 8
    spoutCup_weight = 8
    ...
    button1 = tk.Button(master=backstaffpicker, text='Hvid \n plastikkop', command = lambda: approve(type, str(int(weight) - plasticGlass_weight), comment, "Hvid plastikkop"), bg = '#007f93', fg = 'white', height = 1, width = 1)
    button1.grid(row=0, column=0, padx=25, pady=125, sticky='NSEW')
    button1.config(font=('Helvetica', 25))
    # button1.pack()

    button2 = tk.Button(master=backstaffpicker, text='Papkop', command = lambda: approve(type, str(int(weight) - cardboardCup_weight), comment, "Papkop"), bg = '#007f93', fg = 'white', height = 1, width = 1)
    button2.grid(row=0, column=1, padx=25, pady=125, sticky='NSEW')
    button2.config(font=('Helvetica', 25))
    # button2.pack()

    button3 = tk.Button(master=backstaffpicker, text='Tudekop', command = lambda: approve(type, str(int(weight) - spoutCup_weight), comment, "Tudekop"), bg = '#007f93', fg = 'white', height = 1, width = 1)
